...
var file_proto_test_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x67, 0x72, 0x70, 0x63, 0x1a, 0x1c, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	...
	,
...
var file_proto_test_proto_depIdxs = []int32{
	0, // 0: grpc.TestService.Test:input_type -> grpc.TestRequest
	2, // 1: grpc.TestService.Hello:input_type -> grpc.HelloRequest
	1, // 2: grpc.TestService.Test:output_type -> grpc.TestResponse
	3, // 3: grpc.TestService.Hello:output_type -> grpc.HelloResponse
...
func (c *testServiceClient) Test(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.TestService/Test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.TestService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestService_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.TestService/Test",
	}
...
func _TestService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.TestService/Hello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
